...
const WEAPON_WARRIOR = preload("res://ResourceStats/weapon_greatsword.tres")
const WEAPON_ARCHER = preload("res://ResourceStats/weapon_bow.tres")
const WEAPON_MAGE = preload("res://ResourceStats/weapon_wand.tres")
